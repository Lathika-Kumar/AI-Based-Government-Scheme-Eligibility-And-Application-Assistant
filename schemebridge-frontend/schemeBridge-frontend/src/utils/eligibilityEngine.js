...
/**
 * @deprecated
 * NOTE: The backend Scheme Service (EligibilityEngine.java) is the authoritative
 * single source of truth for all eligibility evaluations and recommendation scoring.
 * Production citizen workflows MUST use POST /api/schemes/recommendations or
 * POST /api/schemes/:id/eligibility/evaluate.
 *
 * This client-side helper is retained solely for legacy test suites and offline previews.
 *
