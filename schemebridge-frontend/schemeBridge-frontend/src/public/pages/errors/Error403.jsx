    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-rose-50/20 flex items-center justify-center p-6">
      <div className="max-w-md w-full text-center space-y-8">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-slate-500 leading-relaxed max-w-xs mx-auto">
              You do not have permission to access this module or resource on SchemeBridge.
            </p>
          </div>
        </div>
        ...
        <div className="bg-rose-50 border border-rose-200 rounded-2xl p-4 text-left space-y-1">
          <p className="text-xs font-bold text-rose-800">Why am I seeing this?</p>
          <ul className="text-xs text-rose-700 space-y-1 list-disc list-inside leading-relaxed">
            <li>This section requires Administrative or Officer privileges.</li>
            <li>Your account role does not permit viewing this record.</li>
            <li>Your active session scope does not include this action.</li>
          </ul>
        </div>
        ...
        >
          ...
          Request Elevated Access / Contact Support
        </a>
