  ...
  return (
    <div className="bg-gradient-to-br from-indigo-950 via-slate-900 to-indigo-950 rounded-2xl p-6 text-white shadow-lg border border-indigo-900/40 relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        {/* Phase 25 Recommendation AI/ML Model Governance */}
        <div className="mt-6 pt-5 border-t border-indigo-800/50">
          <div className="flex items-center justify-between mb-3">
            <span className="text-[10px] font-black tracking-wider uppercase text-indigo-300">
              AI/ML Recommendation Model Governance
            </span>
            <span className="px-2 py-0.5 bg-amber-500/20 text-amber-300 text-[9px] font-bold rounded-full uppercase">
              Training: TRAINING_NOT_READY
            </span>
          </div>

          <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-7 gap-3">
            <div className="p-2.5 bg-white/5 rounded-lg border border-white/5">
              <span className="text-[8px] font-bold text-indigo-300 uppercase block">Training Status</span>
              <span className="text-xs font-black text-amber-400">TRAINING_NOT_READY</span>
            </div>
            <div className="p-2.5 bg-white/5 rounded-lg border border-white/5">
              <span className="text-[8px] font-bold text-indigo-300 uppercase block">Active Model</span>
              <span className="text-xs font-mono font-bold text-white truncate block">2.2.0-hybrid-384d</span>
            </div>
            <div className="p-2.5 bg-white/5 rounded-lg border border-white/5">
              <span className="text-[8px] font-bold text-indigo-300 uppercase block">Candidate Model</span>
              <span className="text-xs font-mono text-slate-400">NONE</span>
            </div>
            <div className="p-2.5 bg-white/5 rounded-lg border border-white/5">
              <span className="text-[8px] font-bold text-indigo-300 uppercase block">Shadow Model</span>
              <span className="text-xs font-mono text-slate-400">NONE</span>
            </div>
            <div className="p-2.5 bg-white/5 rounded-lg border border-white/5">
              <span className="text-[8px] font-bold text-indigo-300 uppercase block">Interaction Sessions</span>
              <span className="text-xs font-bold text-white">0 <span className="text-[9px] text-slate-400">/ 100 req</span></span>
            </div>
            <div className="p-2.5 bg-white/5 rounded-lg border border-white/5">
              <span className="text-[8px] font-bold text-indigo-300 uppercase block">Eligibility Violations</span>
              <span className="text-xs font-black text-emerald-400">0.00%</span>
            </div>
            <div className="p-2.5 bg-white/5 rounded-lg border border-white/5">
              <span className="text-[8px] font-bold text-indigo-300 uppercase block">Promotion Status</span>
              <span className="text-xs font-bold text-amber-300">NOT_READY</span>
            </div>
          </div>
        </div>
      </div>
