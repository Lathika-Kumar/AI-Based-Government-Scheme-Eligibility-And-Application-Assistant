  ...
  return (
    <div className="space-y-3.5">
      <div className="flex justify-between items-center">
        ...
        <button
          onClick={onViewAll}
          className="text-[10px] font-black text-indigo-600 dark:text-indigo-400 hover:text-indigo-800 dark:hover:text-indigo-300 transition"
        >
          View All &rarr;
        </button>
      </div>

      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-5 rounded-2xl shadow-sm flex flex-col h-[500px] justify-between">
        <div className="overflow-y-auto pr-1">
          {displayActivities.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-full text-slate-400 dark:text-slate-500 py-12">
              ...
              <p className="text-[10px] text-slate-500 dark:text-slate-400 mt-1">Activities will appear as operations occur.</p>
            </div>
          ) : (
                      ...
                      <div className="relative pb-8">
                        ...
                        <div className="relative flex space-x-3">
                          <div className="shrink-0">
                            <span className={`h-8 w-8 rounded-xl border flex items-center justify-center ring-4 ring-white dark:ring-slate-900 ${iconColor}`}>
                          ...
                          <div className="flex-1 min-w-0 pt-0.5">
                            <div className="flex items-center justify-between gap-1.5">
                              ...
                              <span className="text-[8px] text-slate-400 dark:text-slate-400 font-bold whitespace-nowrap flex items-center gap-1">
                            ...
                            <div className="flex items-center gap-2 mt-1.5">
                              ...
                              <span className="text-[9px] font-bold text-indigo-600 dark:text-indigo-400 bg-indigo-50 dark:bg-indigo-950/60 border border-indigo-100 dark:border-indigo-800/60 px-1.5 py-0.5 rounded">
                                {act.module}
                              </span>
                            </div>
                          </div>
        ...
        <div className="border-t border-slate-100 dark:border-slate-800 pt-4 mt-4">
          <button
            onClick={onViewAll}
            className="w-full py-2 bg-slate-50 hover:bg-slate-100 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-600 dark:text-slate-300 rounded-xl text-xs font-black border border-slate-200 dark:border-slate-700 transition"
          >
