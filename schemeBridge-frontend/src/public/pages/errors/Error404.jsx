...
export default function Error404() {
  ...
  const QUICK_LINKS = [
    { label: "Citizen Dashboard", path: "/dashboard", desc: "View your active applications & updates" },
    { label: "Find Schemes", path: "/recommendations", desc: "Browse & discover eligible schemes" },
    { label: "Document Vault", path: "/documents", desc: "Manage & verify required documents" },
    { label: "Application Tracker", path: "/tracker", desc: "Track status of submitted schemes" },
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-indigo-50/20 flex items-center justify-center p-6">
      <div className="max-w-lg w-full text-center space-y-8">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-slate-500 leading-relaxed max-w-sm mx-auto">
              The e-Governance resource or page you requested could not be located. It may have been moved, renamed, or deleted.
            </p>
          </div>
        </div>
        ...
        <div className="inline-flex items-center gap-1.5 text-xs text-slate-400">
          ...
          Looking for a scheme? Try exploring{" "}
