            ...
            <div className="flex items-center gap-2">
              {!notif.read && (
                <button
                  ...
                  className="text-[11px] font-semibold text-government-blue hover:text-blue-800 transition"
                >
                  Mark as read
                </button>
              )}
              {notif.actionRoute && (
                <button
                  ...
                  className="text-[11px] font-semibold text-slate-700 hover:text-slate-900 bg-slate-100 hover:bg-slate-200 px-2.5 py-1 rounded-lg transition"
                >
                  View Details
                </button>
              )}
    ...
    <div className="space-y-5">
      ...
      {filtered.length === 0 ? (
        <div className="py-16 flex flex-col items-center text-center text-gray-400">
          ...
          <h3 className="text-sm font-bold text-gray-600">All Caught Up!</h3>
