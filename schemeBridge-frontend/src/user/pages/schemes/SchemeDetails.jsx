              ...
              <div className="space-y-6">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <div className="bg-gray-50 border border-gray-200 p-5 rounded-xl">
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <h4 className="text-sm font-bold text-gray-900">Implementing Department</h4>
                    </div>
                ...
                {recDetails && (
                  <div className="bg-government-blue/5 border border-government-blue/20 p-5 rounded-xl">
                    <h4 className="text-sm font-bold text-government-blue mb-2">AI Recommendation Rationale</h4>
              ...
              <div className="space-y-6">
                ...
                <ul className="space-y-4">
                  {Array.isArray(scheme.benefits) ? (
                    ...
                    <li className="text-sm text-gray-500">No benefit details listed.</li>
                  )}
                </ul>
              </div>
            )}
                ...
                <div className="space-y-4">
                  ...
                  {evaluation?.unmetConditions.length > 0 && (
                    <div className="bg-red-50 border border-red-200 rounded-xl p-5 space-y-3">
                      <h4 className="text-xs font-bold text-red-800 uppercase tracking-widest">Unmet Criteria</h4>
                      <ul className="space-y-2">
