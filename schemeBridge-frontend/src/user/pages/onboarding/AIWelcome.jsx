      ...
      <div className="bg-slate-900 px-8 py-8 text-center relative overflow-hidden">
        ...
        <div className="relative z-10 space-y-3">
          ...
          <h2 className="text-xl font-extrabold text-white">
            Meet the SchemeBridge AI Engine
          </h2>
          <p className="text-slate-400 text-xs max-w-sm mx-auto leading-relaxed">
            Welcome, {user?.name || "Citizen"}. Let's analyze your demographic profile to verify eligibility for state and central benefits.
          </p>
        </div>
      </div>
      ...
      <div className="px-8 py-7 space-y-6">
        <div className="space-y-4">
          <p className="text-xs font-semibold text-slate-500 uppercase tracking-wide">
            How the AI Profiling System Works:
          </p>
          ...
          <div className="space-y-3">
            ...
            <div className="flex gap-3.5 items-start p-3 hover:bg-slate-50 rounded-2xl transition duration-150 border border-transparent hover:border-slate-100">
              ...
              <div>
                <h4 className="text-xs font-bold text-slate-800">1. Demographics Profiling</h4>
                <p className="text-[11px] text-slate-500 mt-0.5 leading-relaxed">
                  We check baseline age, caste, household income thresholds, and state limits against active welfare rules.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-3.5 items-start p-3 hover:bg-slate-50 rounded-2xl transition duration-150 border border-transparent hover:border-slate-100">
              ...
              <div>
                <h4 className="text-xs font-bold text-slate-800">2. Automated Credentials Audit</h4>
                <p className="text-[11px] text-slate-500 mt-0.5 leading-relaxed">
                  Connect DigiLocker or drop manual files. Our engine scans metadata signatures to pre-verify document vault statuses.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-3.5 items-start p-3 hover:bg-slate-50 rounded-2xl transition duration-150 border border-transparent hover:border-slate-100">
              ...
              <div>
                <h4 className="text-xs font-bold text-slate-800">3. Unified Application Matching</h4>
                <p className="text-[11px] text-slate-500 mt-0.5 leading-relaxed">
                  Calculates eligibility percentages and flags document blockers so you can apply with one click.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-[10px] leading-relaxed text-slate-500">
          🔒 Privacy Policy Commitment: All demographic data is secured locally under localStorage sandbox models and evaluated without transmitting private identifiers to unverified third parties.
        </div>
        ...
        >
          <span>Begin AI-Driven Setup</span>
