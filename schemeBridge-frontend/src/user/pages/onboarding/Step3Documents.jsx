          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-slate-400 text-xs mt-0.5">
                Upload your documents or connect DigiLocker
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="px-8 py-7 space-y-5">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            >
              ...
              <span className="text-xs font-bold text-emerald-800">Connect DigiLocker</span>
              <span className="text-[10px] text-emerald-600 text-center leading-tight">
                Import verified government certificates instantly
              </span>
            </button>
            ...
            >
              ...
              <span className="text-xs font-bold text-indigo-800">Upload Manually</span>
              <span className="text-[10px] text-indigo-600 text-center leading-tight">
                Add document details one by one
              </span>
            </button>
          </div>
          ...
          {documents.length > 0 ? (
            ...
            <div className="text-center py-4 text-slate-400 text-xs">
              ...
              No documents added yet. Use DigiLocker or upload manually above.
            </div>
          )}
