...
return n.category === "deadline";
  ...
  const navItems = [
    ...
    { name: "Eligibility Profile", path: "/profile", icon: UserCircle },
    { name: "Matching Schemes", path: "/recommendations", icon: Sparkles },
    { name: "Document Vault", path: "/documents", icon: FileText },
    { name: "Application Tracker", path: "/tracker", icon: ClipboardList },
    { name: "Help & Support", path: "/help", icon: HelpCircle },
    { name: "Your Feedback", path: "/feedback", icon: ThumbsUp }
  ];
        ...
        <div className="h-16 flex items-center px-6 bg-slate-950 border-b border-slate-800">
          <Link to="/" className="flex items-center space-x-2.5">
            ...
            <div>
              ...
              <span className="text-[9px] text-slate-400 block tracking-widest uppercase font-semibold">Citizen Account</span>
            </div>
          </Link>
        </div>
        ...
        <div className="p-4 border-b border-slate-800 bg-slate-900/50">
          <div className="flex items-center space-x-3">
            ...
            <div className="overflow-hidden">
              <p className="text-xs font-semibold text-slate-200 truncate">{user?.name || "Citizen Account"}</p>
          ...
          <div className="relative flex flex-col w-64 max-w-xs bg-slate-900 text-white h-full shadow-xl">
            ...
            <div className="p-4 border-b border-slate-800">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="text-xs font-semibold truncate">{user?.name || "Citizen Account"}</p>
  ...
  Caste: <strong className="text-indigo-705 text-indigo-700 font-semibold">{user?.caste || "OBC"}</strong>
</span>
            </div>
          </div>
        </header>
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-3">
              {filteredNotifications.length === 0 ? (
                <div className="flex flex-col items-center justify-center text-center py-24 text-slate-400 space-y-2.5">
                  ...
                  <p className="text-[10px] max-w-[220px] text-slate-400 leading-relaxed">You have no new notifications</p>
                </div>
              ) : (
                    ...
                    >
                      ...
                      <div className="flex flex-wrap items-center justify-between gap-2 border-t border-slate-100/60 pt-2 text-[9px] font-bold">
                        <div className="flex gap-1.5">
                          ...
                          <span className="text-slate-400 font-medium self-center">{timeAgo(notif.timestamp)}</span>
                        </div>
