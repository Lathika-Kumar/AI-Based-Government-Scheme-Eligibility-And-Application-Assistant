...
export default function StatCard({
  ...
  return (
    <Tag
      onClick={onClick}
      className={`bg-white border border-slate-200 rounded-2xl p-5 shadow-sm border-b-2 hover:shadow-md transition duration-200 text-left w-full ${accentBorder} ${onClick ? "cursor-pointer hover:bg-slate-50" : ""} ${className}`}
    >
