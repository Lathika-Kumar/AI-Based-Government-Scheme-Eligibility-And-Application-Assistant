...
export default function ProgressCard({
  ...
  return (
    <div
      className={`bg-white border border-slate-200 rounded-2xl p-5 shadow-sm hover:shadow-md transition duration-200 ${className}`}
    >
      {/* Header */}
      ...
      {/* Progress bar */}
      <div
        className={`h-2.5 w-full rounded-full ${c.track} overflow-hidden`}
        role="progressbar"
        aria-valuenow={pct}
        aria-valuemin={0}
        aria-valuemax={100}
