...
export default function AdminSettingsPanel() {
  ...
  const handleSave = (e) => {
    e.preventDefault();
    showToast("success", "Settings Saved", "All government platform configuration settings saved successfully!");
  };
        ...
        <div className="flex-1 p-6 overflow-y-auto">
          <form onSubmit={handleSave} className="space-y-6 text-xs font-semibold text-slate-700">
            ...
            {activeSection === "security" && (
              <div className="space-y-4">
                ...
                <div className="space-y-2 pt-2 border-t border-slate-100">
                  <button
                    type="button"
                    onClick={() => showToast("info", "Optimization", "Indices optimized successfully.")}
                  ...
                  <button
                    type="button"
                    onClick={() => showToast("success", "Backup Created", "Local database configuration backed up.")}
                    className="px-4 py-2 border border-slate-200 hover:bg-slate-50 text-slate-600 rounded-xl font-bold transition flex items-center gap-1.5"
                  >
            ...
            <div className="pt-4 border-t border-slate-100 flex justify-end gap-2">
              <button
                type="button"
                onClick={() => showToast("warning", "Settings Reset", "All settings have been reset to defaults!")}
