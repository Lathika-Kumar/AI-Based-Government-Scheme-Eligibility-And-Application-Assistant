...
export default function ApplicationsManagement({
  ...
  const handleBulkApprove = () => {
    ...
    setSelectedIds([]);
    showToast("success", "Bulk Approval Complete", `Successfully marked ${count} application(s) as Approved.`);
  };
  ...
  const handleBulkReject = () => {
    ...
    setSelectedIds([]);
    showToast("error", "Bulk Rejection Complete", `Marked ${count} application(s) as Rejected.`);
  };
