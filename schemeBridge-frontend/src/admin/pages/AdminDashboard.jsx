...
export default function AdminDashboard({ tab = "overview" }) {
  ...
  const activeAppForReview = useMemo(() => {
    ...
    return applications.find((a) => a.id === selectedAppForReview.id) || selectedAppForReview;
    ...
    <div className="space-y-5">
      ...
      {confirmModal.isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          />
          <div className="relative bg-white rounded-2xl border border-slate-200 shadow-2xl max-w-sm w-full max-h-[90vh] overflow-y-auto z-10 p-6 space-y-4 animate-in fade-in zoom-in-95 duration-150">
