    ...
    <div className="flex flex-col h-screen bg-slate-50 font-sans overflow-hidden">
      ...
      <div className="flex-1 flex overflow-hidden relative">
        ...
        <div className="flex-grow flex flex-col min-w-0 overflow-y-auto lg:ml-64 ml-0">
          ...
          {/* ── TOP HEADER ── */}
          <header className="sticky top-0 bg-white border-b border-slate-200 h-16 shrink-0 flex items-center justify-between px-4 sm:px-6 shadow-sm z-20">
            <div className="flex items-center gap-3">
              {/* Mobile Drawer Hamburger Trigger */}
              <button
                onClick={() => setMobileMenuOpen(!mobileMenuOpen)}
                className="lg:hidden p-2 hover:bg-slate-100 border border-slate-200 text-slate-600 rounded-xl transition"
